...
// Domain constants for the Orka file management service.
const (
...
// FileManagement returns the RBAC configuration for the Orka file management
// service. This is a preset — it provides a complete, valid Config that can be
// passed directly to rbac.New or rbac.MustNew.
